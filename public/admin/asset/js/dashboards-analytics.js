"use strict";
! function () {
    // $('#totalRevenueChart').ready(function(){
    //     let naData = $(this).attr('data-values');
    // });
    let o, r, e, t, s;
    ...
    // let dataaa = $('#totalRevenueChart').attr('data-values');
    // console.log(dataaa);
    i = document.querySelector("#totalRevenueChart"), a = {
        series: [
            // {
            //     name: "2021",
            //     data: dataaa
