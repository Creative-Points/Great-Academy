...
<head>
    ...
    <title>403 USER DOES NOT HAVE THE RIGHT ROLES!</title>
    ...
    <main>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                    <h1>403</h1>
                    <h2>UH OH! USER DOES NOT HAVE THE RIGHT ROLES.</h2>
                    {{-- <p>USER DOES NOT HAVE THE RIGHT ROLES.
                        How you got here is a mystery. But you can click the button below
                        to go back to the homepage.
                    </p> --}}
                    <a class="btn green" href="{{ url()->previous() }}">Back</a>
                </div>
            </div>
        </div>
    </main>
