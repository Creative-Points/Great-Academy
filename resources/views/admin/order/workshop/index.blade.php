            ...
            <div class="row mx-2 py-2">
                ...
                <div class="col-md-10">
                    <div
                        ...
                        <form action="{{ route('dashboard.order.workshop.wSearch') }}" method="post">
                            @csrf
                            ...
                            <td>
                                <div class="d-flex justify-content-start align-items-center">
                                    <div class="d-flex flex-column">
                                        <a href="{{ route($routeName.'.order.workshop.view', $item->ocode) }}" class="text-body text-truncate">
                            ...
                            <td>
                                <div class="d-inline-block">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="{{ route($routeName.'.order.workshop.view', $item->ocode) }}" id='confirm-color1' class="dropdown-item">View</a>
                                        ...
                                        <form class="" method="POST"
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                class="dropdown-item text-danger delete-record" id="confirm-color1">Delete</button>
                                        </form>
                                        @endrole
                                    </div>
                                </div>
